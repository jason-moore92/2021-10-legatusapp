    ...
    Future.delayed(Duration(milliseconds: 500), () async {
      if (_localMediaListState.localLocalReportModel!.medias!.length !=
        ...
        String createdAt = KeicyDateTime.convertDateStringToMilliseconds(
                dateString:
                    _localMediaListState.localLocalReportModel!.createdAt)
            .toString();
      ...
      List<dynamic> localMediaListData =
          _localMediaListState.localMediaListData!;
      ...
      try {
        ...
        for (var i = page * limit; i < (page + 1) * limit; i++) {
          if (i <
            ...
            for (var k = 0;
                k <
                    _localMediaListState.localLocalReportModel!
                        .orderList![index]["ranks"].length;
                k++) {
