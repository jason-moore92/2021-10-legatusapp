        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Icon(Icons.folder_outlined, size: heightDp! * 22, color: Colors.black),
                SizedBox(width: widthDp! * 5),
                Expanded(
                  child: Text(
              ...
              Column(
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.location_on_outlined, size: heightDp! * 22, color: Colors.black),
                      SizedBox(width: widthDp! * 5),
                      Expanded(
                        child: Text(
              ...
              Column(
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.business, size: heightDp! * 22, color: Colors.black),
                      SizedBox(width: widthDp! * 5),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Column(
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.local_police_outlined, size: heightDp! * 22, color: Colors.black),
                      SizedBox(width: widthDp! * 5),
                      Expanded(
