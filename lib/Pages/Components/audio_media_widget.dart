...
class AudioMediaWidget extends StatefulWidget {
  ...
  @override
  AudioMediaWidgetState createState() => AudioMediaWidgetState();
}

class AudioMediaWidgetState extends State<AudioMediaWidget> {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.mic_none_outlined, size: iconSize * 1.2),
                SizedBox(width: widthDp * 5),
                Expanded(
                  child: Row(
                    children: [
                          ...
                          children: [
                            Text(
                              LocaleKeys.LocalReportWidgetString_audios.tr()
                                  .substring(0, LocaleKeys.LocalReportWidgetString_audios.tr().length - 1),
