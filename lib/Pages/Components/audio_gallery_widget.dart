...
class AudioGalleryWidget extends StatefulWidget {
  ...
  @override
  _AudioGalleryWidgetState createState() => _AudioGalleryWidgetState();
}

class _AudioGalleryWidgetState extends State<AudioGalleryWidget> {
        ...
        children: [
          if (audioPlayer.state == PlayerState.COMPLETED ||
            ...
            GestureDetector(
              ...
              child: Container(
                padding: EdgeInsets.symmetric(
                    horizontal: widthDp * 3, vertical: heightDp * 5),
          ...
          if (audioPlayer.state == PlayerState.PLAYING)
            GestureDetector(
              ...
              child: Container(
                padding: EdgeInsets.symmetric(
                    horizontal: widthDp * 5, vertical: heightDp * 5),
